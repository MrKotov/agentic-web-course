    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "phase",
                    models.CharField(
                        choices=[("PRE", "Преди лекцията"), ("POST", "След лекцията")], max_length=8
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "research_id",
                    models.CharField(
                        default=quiz.models.generate_research_id, max_length=32, unique=True
                    ),
                ),
                ("created_at", models.DateTimeField(default=django.utils.timezone.now)),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="items", to="quiz.topic"
            ),
        ),
        migrations.CreateModel(
            name="Response",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("DELEGATED", "Делегиране"),
                            ("EXPLANATORY", "Обяснително"),
                            ("MIXED", "Смесено"),
                            ("NONE", "Без агент"),
                        ],
                        max_length=16,
